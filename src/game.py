...
class Game:
    ...
    def draw_hud(self, shake_x=0, shake_y=0) -> None:
        ...
        # Score
        score_text = get_text(f"Score: {int(self.score)}", font, (255, 255, 0))
        self.screen.blit(score_text, (10 + shake_x, 10 + shake_y))

        # Wave
        wave_text = get_text(f"Wave: {self.wave}", font, (255, 100, 100))
        ...
        # Health text
        health_text = get_text(f"{int(self.player.health)}/{int(self.player.max_health)}", small_font, (255, 255, 255))
        self.screen.blit(
            health_text,
            (
        ...
        # XP text
        xp_text = get_text(f"{int(self.player_xp)}/{int(self.xp_to_next_level)}", small_font, (255, 255, 255))
        self.screen.blit(
            xp_text,
            (
        ...
        # Level
        level_text = get_text(f"Level {self.player_level}", font, (255, 215, 0))
        self.screen.blit(
            level_text,
            (
