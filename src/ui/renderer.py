...
class UIGameRenderer:
    ...
    _LAMP_GLOW_CONFIG = {
        "limbo": {"min_pulse": 0.50, "alpha": 100, "glow_offset": -3},
        "limbo_final": {"min_pulse": 0.50, "alpha": 100, "glow_offset": -3},
    ...
    def _draw_torches(self, shake_x=0, shake_y=0) -> None:
        ...
        if prologo_torches:
            for torch in prologo_torches:
                ...
                glow_radius_base = torch.get("glow_radius", 18)
                glow_radius = int(glow_radius_base * pulse_value)
