...
def test_orbital_projectile_color():
    ...
    assert w == 8 and h == 8, f"Orbital projectile should be 8x8 (radius 4), got {w}x{h}"
    ...
    assert is_light_blue or is_dark_blue, f"Should be light or dark blue, got {center_color[:3]}"
